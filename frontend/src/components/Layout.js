...
export default function Layout() {
    ...
    const splitToggleButton = (_jsxs("button", { type: "button", className: `split-toggle-btn ${splitOpen ? "active" : ""}`, onClick: () => {
            setSplitOpen((s) => !s);
            if (splitOpen)
                setSplitView(null);
        }, title: splitOpen ? "Close split view" : "Open split view", "aria-label": splitOpen ? "Close split view" : "Open split view", children: [_jsxs("span", { className: "split-btn-icon", "aria-hidden": "true", children: [_jsx("span", { className: "split-btn-pane" }), _jsx("span", { className: "split-btn-divider", children: "\u25EB" }), _jsx("span", { className: "split-btn-pane" })] }), _jsx("span", { className: "split-toggle-text", children: "Split view" })] }));
