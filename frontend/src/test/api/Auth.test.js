...
describe("api/Auth", () => {
    ...
    describe("register", () => {
        ...
        it("throws server message on non-2xx", async () => {
            ...
            await expect(register("a@b.c", "pw", "pw")).rejects.toThrow("User already exists");
        });
    });
    describe("login", () => {
    ...
    describe("resetPassword", () => {
        ...
        it("throws on invalid token", async () => {
            ...
            await expect(resetPassword("bad", "x")).rejects.toThrow("Invalid or expired link");
        });
    });
    describe("changePassword", () => {
        ...
        it("throws server message on non-2xx", async () => {
            ...
            await expect(changePassword("wrong", "newpass1")).rejects.toThrow("Current password is incorrect");
        });
    });
});
